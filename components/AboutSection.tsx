...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="py-20 px-6" style={{ backgroundColor: '#0D0C24' }} ref={sectionRef}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
          ...
          <div className="reveal-right flex flex-col justify-between">
            <div className="mb-8">
              ...
              <h2 className="font-bold text-3xl md:text-4xl leading-tight tracking-tight mb-4 reveal-up stagger-1" style={{ color: "#ffffff" }}>
                What We Can Do More in{' '}
                <span className="text-gradient-sky">Different Cases</span>
              </h2>
              <p className="text-sm leading-relaxed mb-2 reveal-up stagger-2" style={{ color: "rgba(255,255,255,0.55)" }}>
                Our Advisors Advise
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 flex-1">
              {capabilities.map((cap, i) => (
                <div
                  ...
                  style={{ borderColor: "rgba(30,155,240,0.20)", backgroundColor: "rgba(30,155,240,0.06)" }}
                  onMouseEnter={(e) => {
                    (e.currentTarget as HTMLDivElement).style.borderColor = "rgba(30,155,240,0.50)";
                    (e.currentTarget as HTMLDivElement).style.backgroundColor = "rgba(30,155,240,0.12)";
                  }}
                  onMouseLeave={(e) => {
                    (e.currentTarget as HTMLDivElement).style.borderColor = "rgba(30,155,240,0.20)";
                ...
                >
                  ...
                  <div>
                    <p className="text-sm font-semibold mb-1" style={{ color: "#ffffff" }}>{cap.title}</p>
                    <p className="text-xs leading-relaxed" style={{ color: "rgba(255,255,255,0.55)" }}>{cap.description}</p>
                  </div>
                </div>
              ))}
            </div>
